...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <h1><%: Title %>.</h1>
                <h2>Welcome to WeR Troubleshooting Center</h2>
            </hgroup>
            <p>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <h3>Please choose one of the following options to troobleshoot WeR solution:</h3>
    <ol class="round">
        <li class="one">
        ...
        <li class="two">
            <h5>Open WeR Troobleshooting page to check online</h5>
            Open WeR Troobleshooting page to check online.
